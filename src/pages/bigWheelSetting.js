    ...
    return (
      <Tabs onChange={this.callback} type="card">
        ...
        <TabPane tab={<FormattedMessage id="setting.navBar.imeiSetting"/>} key="2">
          {imeiDetail && Object.keys(imeiDetail).length &&
          <IMEISetting detail={imeiDetail} id={this.props.location.query.id}/>}
        </TabPane>
        ...
        <TabPane tab={<FormattedMessage id="setting.navBar.probabilitySetting"/>} key="4">
          {Object.keys(probabilityDetail).length &&
          <PossibilitySetting detail={probabilityDetail} id={this.props.location.query.id}/>}
          {/*<PossibilitySetting detail={probabilityDetail} id={this.props.location.query.id}/>*/}
        </TabPane>
      </Tabs>
    );
